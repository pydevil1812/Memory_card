...
questions_list.append(
        Question('Президент США', 'Байден', 'Путин', 'Трамп', 'Зеленский'))
questions_list.append(
        Question('Самая большая страна', 'Россия', 'Беларусь', 'Китай', 'Уганда'))
questions_list.append(
        Question('Что такое инфляция?', 'автор не знает', 'я не знаю', 'что-то с чем-то', 'другой ответ'))
